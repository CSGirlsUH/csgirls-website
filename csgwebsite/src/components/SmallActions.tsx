...
function SmallActions(props: CardProps) {
  return (
    <div className="flex flex-col justify-start items-center align-top min-w-[195px] min-h-[194px] mr-[14px] bg-bggray rounded-[30px]">
      <h1 className="flex text-xl min-w-[160px] font-medium self-start pl-3 mt-3 mb-1">
        {props.title}
      </h1>
      <p className="flex pl-3 text-sm max-w-[173px] self-start">
        {props.pText}
      </p>
      <button
        className={
